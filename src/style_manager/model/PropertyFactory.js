...
export default class PropertyFactory {
  constructor() {
    ...
    this.optsFloat = [
      { id: 'none', className: 'far fa-times' },
      { id: 'left', className: 'far fa-align-left' },
      { id: 'right', className: 'far fa-align-right' },
    ];
  ...
  init() {
    ...
    [
      ...
      ['bottom', {}, 'top'],
      ['left', {}, 'top'],
      ['margin-top', { default: '0', iconName: 'far fa-arrow-to-top' }, 'top'],
      ['margin-right', { iconName: 'far fa-arrow-to-right' }, 'margin-top'],
      ['margin-bottom', { iconName: 'far fa-arrow-to-bottom' }, 'margin-top'],
      ['margin-left', { iconName: 'far fa-arrow-to-left' }, 'margin-top'],
      ['padding-top', { min: 0 }, 'margin-top'],
      ['padding-right', { iconName: 'far fa-arrow-to-right' }, 'padding-top'],
      ['padding-bottom', { iconName: 'far fa-arrow-to-bottom' }, 'padding-top'],
      ['padding-left', { iconName: 'far fa-arrow-to-left' }, 'padding-top'],
      ['width', { min: 0, textLabel: 'W' }, 'top'],
      ['min-width', {}, 'width'],
      ['max-width', {}, 'width'],
      ['height', { textLabel: 'H' }, 'width'],
      ['min-height', {}, 'width'],
      ['max-height', {}, 'width'],
      ['flex-basis', { requiresParent: requireFlex }, 'width'],
      [
        'font-size',
        { default: 'medium', fixedValues: this.fixedFontSizes, textLabel: '', iconName: 'far fa-text-size' },
        'width',
      ],
      ['letter-spacing', { default: 'normal', fixedValues: this.fixedLetSpace }, 'top'],
      ['line-height', { iconName: 'far fa-line-height' }, 'letter-spacing'],
      ...
      ['border-top-left-radius', { iconName: 'far fa-chevron-up' }, 'border-radius-c'],
      ['border-top-right-radius', { iconName: 'far fa-chevron-up' }, 'border-radius-c'],
      ['border-bottom-left-radius', { iconName: 'far fa-chevron-up' }, 'border-radius-c'],
      ['border-bottom-right-radius', { iconName: 'far fa-chevron-up' }, 'border-radius-c'],
      ['border-width', { units: this.unitsSizeNoPerc, iconName: 'border-width' }, 'border-radius-c'],
      ...
      // Select types
      ['display', { type: this.typeSelect, default: 'block', options: this.opstDisplay, iconName: 'far fa-eye' }],
      ...
      ['font-family', { default: 'Arial, Helvetica, sans-serif', options: this.optsFonts, iconName: null }, 'display'],
      ['font-weight', { default: '400', options: this.optsWeight, iconName: 'far fa-text-width' }, 'display'],
      ['border-style', { default: 'solid', options: this.optsBorderStyle, iconName: 'far fa-border-style' }, 'display'],
